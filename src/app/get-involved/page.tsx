...
export default function GetInvolvedPage() {
  return (
    <main className="max-w-2xl mx-auto px-4 py-12">
      ...
      <p className="text-slate-700 mb-6">We welcome volunteers, donors, and partners of all backgrounds. Whether you want to join a cleanup, support habitat restoration, or help with education and outreach, your involvement makes a difference. We offer inclusive opportunities for veterans and people with disabilities, and can accommodate groups and corporate volunteer days.</p>
      <div className="mb-8">
      ...
      <section id="volunteer" className="mb-10">
        ...
        <p className="text-slate-700 mb-2">Fill out the form below to express interest in volunteering. We’ll contact you with upcoming opportunities.</p>
        ...
        <form className="space-y-3" action="https://formspree.io/f/xwkdygqg" method="POST">
          ...
          <div>
            <label htmlFor="interest" className="block text-sm font-medium text-slate-700">How would you like to help?</label>
            <textarea id="interest" name="interest" rows={3} className="mt-1 block w-full rounded border-stone-300 focus:ring-emerald-600 focus:border-emerald-600" />
          </div>
      ...
      <section id="donate" className="mb-10">
        ...
        <p className="text-slate-700 mb-2">Your donation directly supports hands-on stewardship, restoration, and education.</p>
